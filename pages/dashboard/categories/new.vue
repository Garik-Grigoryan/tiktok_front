...
<script>
  export default {
    ...
    methods: {
      ...
      addCategory() {
        this.$store.dispatch('categories/addCategory', [this.name_en, this.name_am, this.name_ru, this.order, this.selectedImages, this.color, this.selectedBrand, this.parentCategory]).then(r => {
