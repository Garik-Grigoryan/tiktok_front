...
export const actions = {
  ...
  async addProperty({commit}, [type, value, name_en, name_am, name_ru]){
    const property = await this.$axios.$post(`http://tiktokback.neoteric-software.com/api/productProperties/add`, {'type': type, 'value': value, 'name_en': name_en, 'name_am': name_am, 'name_ru': name_ru});
    commit('setProperty', property)
  },
  async updateProperty({commit}, [id, type, value, name_en, name_am, name_ru]){
    const property = await this.$axios.$put(`http://tiktokback.neoteric-software.com/api/productProperties/update/${id}`, {'type': type, 'value': value, 'name_en': name_en, 'name_am': name_am, 'name_ru': name_ru});
    commit('setProperty', property)
  },
